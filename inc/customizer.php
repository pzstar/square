...
function square_customize_register($wp_customize) {
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'square_template_color', array(
        'section' => 'colors',
        'label' => esc_html__('Template Color', 'square-plus')
    )));
    ...
    $wp_customize->add_setting('square_social_google_plus', array(
        'default' => '',
        'transport' => 'postMessage',
        'sanitize_callback' => 'esc_url_raw'
    ));

    $wp_customize->add_control('square_social_google_plus', array(
        'settings' => 'square_social_google_plus',
        'section' => 'square_social_sec',
        'type' => 'text',
        'label' => esc_html__('Google Plus', 'square')
    ));
