...
/** Color Tab Control */
class Square_Box_Shadow_Control extends WP_Customize_Control {
    ...
    protected function l10n($id = false) {
        $translation_strings = array(
            'box_shadow' => esc_attr__('Box Shadow', 'square'),
            'x' => esc_attr__('X', 'square'),
            'y' => esc_attr__('Y', 'square'),
            'blur' => esc_attr__('Blur', 'square'),
            'spread' => esc_attr__('Spread', 'square'),
            'inset' => esc_attr__('Inset', 'square'),
            'color' => esc_attr__('Color', 'square'),
        );
        if (false === $id) {
