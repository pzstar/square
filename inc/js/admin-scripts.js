function square_upload_media_image(selector) {
    // ADD IMAGE LINK
...
function square_delete_media_image(selector) {
    // DELETE IMAGE LINK
    jQuery('body').on('click', selector, function (event) {
...
jQuery(document).ready(function (jQuery) {
    square_upload_media_image('.square-upload-button');
    square_delete_media_image('.square-delete-button');
});
